...
export default function EmployeeCalendarPage() {
  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
      <Sidebar role={session?.role || "EMPLOYEE"} />
        ...
        <div className="p-8 space-y-6 overflow-y-auto">
          <div className="flex items-center justify-between">
            <div className="space-y-1">
              ...
              <p className="text-slate-500">Track your upcoming deadlines and schedules.</p>
            </div>
                      ...
                      <div className="space-y-2 h-full flex flex-col">
                        ...
                        <div className="flex-1 space-y-1 overflow-y-auto custom-scrollbar">
                          {dayTasks.map((task, idx) => (
                            <div key={idx} className="text-[10px] p-1.5 rounded-lg bg-emerald-50 border border-emerald-100 text-emerald-700 font-medium truncate flex items-center gap-1.5" title={task.title}>
